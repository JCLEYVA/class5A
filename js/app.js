...
function sum(a, b) {
  return [a + b, 'The sum of 4 and 7 is 11.']; //eslint-disable-line
...
function sumArray(sumArr) { //eslint-disable-line
  var sumOfArray = sum(testArray[0], testArray[1]);
  var sumOfArrayMultiply = sumOfArray[0];
  var sumOfArray2  = sum(sumOfArrayMultiply, testArray[2]);
  var totalSumOfArray = sumOfArray2[0];
  var sumArrayString = sumArr + ' was passed in as an array of numbers, and ' + totalSumOfArray + ' is their sum.';

  return [totalSumOfArray, sumArrayString];
}
